...
import io.nemesiscodex.config.audit.AuditEventConverter;
import io.nemesiscodex.domain.PersistentAuditEvent;
...
import static io.nemesiscodex.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
